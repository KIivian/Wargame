...
namespace Wargame
{
    public class Map
    {
        ...
        public Map(int width, int height) { Formation = new Hexagon[width, height]; Width = width; Height = height; }
        ...
        public static List<Point> GetPlacementField(Map map, int start, int end)
        {
